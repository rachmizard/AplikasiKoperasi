<?php $__env->startSection('dashboard'); ?>
    <div class="container-fluid">
      ...
      <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active"><?php echo e(route('index.petugas')); ?></li>
      </ol>
      ...
      <div class="card mb-3">
        ...
        <div class="card-body">
         <div class="table-responsive">
            <?php $__currentLoopData = $petugas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $got): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <form action="<?php echo e(route('petugas.destroy', $got->id)); ?>">
            ...
            <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
              ...
              <tbody>
                ...
                <td><?php echo e($in->tmp_lhr); ?></td>
                <td><?php echo e($in->tgl_lhr); ?></td>
                <td>
                    <a href="<?php echo e(route('petugas.edit', $in->id)); ?>">Edit</a>
                </td>
                <td>
        ...
        <div class="card-footer small text-muted">Table Petugas
            ...
            <a href="<?php echo e(route('petugas.create')); ?>" class="btn btn-primary">Tambah data</a>
